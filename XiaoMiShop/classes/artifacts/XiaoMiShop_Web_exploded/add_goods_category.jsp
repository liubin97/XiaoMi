                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            ...
                            <div class="widget-body  am-fr">
								...
								<form class="am-form tpl-form-line-form" name="" action="insertCategory.action" method="post" >
									 <div class="am-form-group">
												<label class="am-u-sm-3 am-form-label" >商品类别名称</label>
												<div class="am-u-sm-9">
													<input type="text" name="category_name" class="am-form-field" placeholder="商品类别名称" >
												</div>
											</div>
											<div class="am-form-group">
