        ...
        <div class="container">
            <div class="row row-rl-10 row-tb-20">
                ...
                <div class="popup_mask" id="pop1" style="display: none;">
                    <div class="bkc"></div>
                    <div class="mod_wrap">
                        <div class="mod_acc_tip layereditinfo" id="pop2"
                             style="display: none;width:600px; height:450px">
                            ...
                            <div class="mod_tip_bd">
                                    ...
                                    <div class="wapbox editbasicinfo">
                                        ...
                                        <div>
                                            姓名:
                                            <label class="labelbox"><input class="nickname" type="text"
                                                                           name="recv_people" maxlength="20"
                                                                           placeholder="收货人"></label>
                                        </div>

                                        <div>
                                            电话:
                                            <label class="labelbox"><input type="text" name="telephone" maxlength="11"
                                                                           placeholder="联系电话"></label>
                                        </div>
                                        ...
                                        <div>
                                            详细地址:
                                            <textarea name="detail_address" placeholder="详细地址" cols="60"
                                                      rows="5"></textarea>
                                        </div>

                                        <div>
                                            邮政编码:
                                            <label class="labelbox"><input class="nickname" type="text" name="zip_code"
                                                                           maxlength="20" placeholder="邮政编码"></label>
                                        </div>
                            ...
                            <div class="box-bd">
                                <div class="user-address-list J_addressList clearfix">
                                    ...
                                    <div class="address-item J_addressItem"
                                         style="border-width:2px; border-style:solid; border-color:#ff6700;">
                                        </c:if>
                                        ...
                                        <div class="address-item J_addressItem">
                                            ...
                                            <dl>
                                                ...
                                                <dd class="uaddress">${al.areaPath} <br>${al.detail_address}
                                                    (${al.zip_code})
                                                </dd>
                                            </dl>
                                            <div class="actions">
                                                <c:if test="${al.isdefault==0}">
                                                    <a class="modify J_addressModify"
                                                       href="updateDefault.action?address_id=${al.address_id}">设为默认</a>
                                                </c:if>
                                                <a class="modify J_addressDel"
                                                   href="deleteAddress.action?address_id=${al.address_id}">删除</a>
                                            </div>
                                        </div>
