                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            ...
                            <div class="widget-body  am-fr">
								<form class="am-form tpl-form-line-form" id="stockForm" action="updateStockAdd.action" method="post">
										...
										<div class="am-form-group">
										  <label class="am-u-sm-3 am-form-label">新增库存量</label>
											<div class="am-u-sm-8">
                                            <input type="number" placeholder="输入数量" name="stock" id="stockNum">
                                            <span id="res_stock" style="color:#ff5b5b;font-size: 14px;"></span>
											</div>
										 	<div class="am-u-sm-1">
                                            <img id="img_stock" src="">
											</div>
										</div>
