            ...
            <div class="page-container ptb-60">
                <div class="container">
                    <section class="sign-area panel p-40">
                        <h3 class="sign-title">注册 <small>Or <a href="login.jsp" class="color-green">登录</a></small></h3>
                        <div class="row row-rl-0">
                            <div class="col-sm-6 col-md-7 col-left">
                                <form class="p-40" action="insertAccount" method="post">
                                    <div class="form-group">
                                        <label><h3>邮箱</h3></label>
                                    ...
                                    <div class="form-group">
                                        <label><h3>昵称</h3></label>
                                        <input type="text" class="form-control input-lg" placeholder="nickname" name="nickname">
                                    </div>
                            ...
                            <div class="col-sm-6 col-md-5 col-right">
                                <div class="social-login p-40">
                                    ...
                                    <div class="text-center color-mid">
                                     	   已经有账号 ? <a href="login.jsp" class="color-green">去登录</a>
                                    </div>
                                </div>
                            </div>
                        </div>
