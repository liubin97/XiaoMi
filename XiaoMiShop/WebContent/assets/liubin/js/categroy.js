        ...
        success: function (data) {//这里的data是由请求页面返回的数据
            ...
            for (var i = 0; i < data.length; i++) {
                var categoryHtml = "<div class=\"container\">\n" +
                    ...
                    "                            <a class=\"category-list\" data-toggle=\"collapse\" data-target=\"#"+
                                                        data[i].goods_category_id + "\">" +
                    "                               <span class=\"fa fa-chevron-down\">&nbsp;</span>"+ data[i].category_name +
                                                    "</a>\n" +
                    "                        </h3>\n" +
                    "                     </header>\n" +
                    "                    <div id=\"" +data[i].goods_category_id +
                                            "\" class=\"row row-rl-15 row-tb-15 t-center collapse in\">\n" ;
                for(var j = 0; j < data[i].goodsList.length; j++){
                    categoryHtml += "            <div class=\"col-xs-6 col-sm-4 col-md-3 col-lg-2\">\n" +
                        "                            <a href=\"displayGoodsPurchaseInfo.action?goods_id=" +
                                                            data[i].goodsList[j].goods_id + "\" class=\"panel is-block\">\n" +
