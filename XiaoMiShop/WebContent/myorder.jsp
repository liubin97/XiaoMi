   ...
   <ul class="order-list">
     ...
     <div class="order-detail"> 
      ...
      <table class="order-detail-table"> 
       <thead> 
        <tr> 
         <th class="col-main"> <p class="caption-info">${ol.order_date}<span class="sep">|</span>${ol.address.recv_people}<span class="sep">|</span>订单号： <a href="" data-stat-id="" onclick="">${ol.order_id}</a><span class="sep">|</span>在线支付</p> </th> 
         <th class="col-sub"> <p class="caption-price" style="width:200px;">订单金额：${ol.sum_money}元</p> </th> 
        </tr> 
       </thead> 
       <tbody> 
        <tr> 
 ...
 <c:forEach items="${ol.order_items}" var="il">
   <li style="height:80px;"> 
    <div class="figure figure-thumb"> 
     ...
     <p class="name"> <a target="_blank" href="displayGoodsPurchaseInfo.action?goods_id=${il.goodsDetail.goods_id}">${il.goodsDetail.goods.goods_name} ${il.goodsDetail.kind} ${il.goodsDetail.color}</a> </p> 
    <p class="price">${il.item_price}元 &times; ${il.order_item_num}</p> 
    </li> 
   </c:forEach>
  </ul>
           </td> 
         <td class="order-actions"> <a class="btn1 btn-small btn-line-gray" href="getDetail.action?order_id=${ol.order_id}" onclick="">订单详情</a> </td> 
        </tr> 
       </tbody> 
      </table> 
     </div></li>
