  ...
  <li class="xm-goods-item">
    <div class="figure figure-img">
      <a href="displayGoodsPurchaseInfo.action?goods_id=${fl.goods_id}" target="_blank" onclick="">
        <img src="${fl.goods.goods_pic_url}"></a>
    </div>
    <h3 class="title">
      <a href="displayGoodsPurchaseInfo.action?goods_id=${fl.goods_id}" target="_blank" onclick="">${fl.goods.goods_name}</a></h3>
    ...
    <div class="actions">
      ...
      <a class="btn1 btn-small btn-primary" target="_blank" href="displayGoodsPurchaseInfo.action?goods_id=${fl.goods_id}" onclick="">查看详情</a></div>
  </li>
</c:forEach>
