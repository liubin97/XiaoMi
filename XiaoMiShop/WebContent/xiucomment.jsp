  					...
  					<div class="uc-nav-box">
                        ...
                        <div class="box-bd">
                            <ul class="uc-nav-list">
								...
								<li  class="active"><a href="selectXiuComment.action?comment_flag=0">评价晒单</a></li>  
           ...
           <div class="box-hd">
                            ...
                            <div class="more clearfix">
                                <ul class="filter-list J_orderType">
                                	<c:if test="${comment_flag==1}">
                                    <li class="first"><a id="J_unpaidTab" href="selectXiuComment.action?comment_flag=0" >未评价</a></li>
                                    <li class="active"><a id="J_sendTab" href="selectXiuComment.action?comment_flag=1" >已评价</a></li>
                                    </c:if>
                                    <c:if test="${comment_flag==0}">
                                    <li class="first active"><a id="J_unpaidTab" href="selectXiuComment.action?comment_flag=0" >未评价</a></li>
                                    <li><a id="J_sendTab" href="selectXiuComment.action?comment_flag=1" >已评价</a></li>
                                    </c:if>
                                    <li></li>
                                    <li></li>
                                    <li></li>
...
<c:forEach items="${xclist}" var="xl">
<c:forEach items="${xl.order_items}" var="ol">
  <li class="xm-goods-item">
    <div class="figure figure-img">
      <a href="" target="_blank" onclick="">
        <img src="${ol.goodsDetail.goods.goods_pic_url}"></a>
    </div>
    <h3 class="title">
      <a href="" target="_blank" onclick="">${ol.goodsDetail.goods.goods_name} ${ol.goodsDetail.kind} ${ol.goodsDetail.color}</a></h3>
    <p class="price">${ol.item_price}元</p>
    <p class="price">所属订单:${xl.order_id}</p>
    <p class="rank"></p>
    <div class="actions">
    <c:if test="${comment_flag==0}">
      
      <a class="btn1 btn-small btn-primary" target="_blank" href="goToMakeCommentPage.action?order_item_id=${ol.order_item_id}" onclick="">去评论</a>
      </c:if>
    </div>
  </li>
  </c:forEach>
