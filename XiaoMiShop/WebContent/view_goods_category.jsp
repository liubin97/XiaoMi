								...
								<div class="widget-body  am-fr">
									...
									<div class="am-u-sm-12 am-u-md-12 am-u-lg-3">
										<div class="am-input-group am-input-group-sm tpl-form-border-form cl-p">
											<input type="text" id="category_name" class="am-form-field " style="width:200px;" placeholder="类别名称">
									...
									<div class="am-u-sm-12 am-u-md-12 am-u-lg-3">
										<div class="am-input-group am-input-group-sm tpl-form-border-form cl-p">
											<input type="text" id="description" class="am-form-field " style="width:200px;" placeholder="描述信息">
