...
<head>
    ...
    <script src="js/editGroupBuyOne.js"></script>
</head>
                        ...
                        <div class="widget-body am-fr">
                            <form class="am-form tpl-form-line-form" action="editGroupBuy.action" method="post">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="hidden" value="${result.goods_detail_id}" id="goods_detail_id_val" />
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-8">
                                        <input type="text" class="tpl-form-input" id="group_num" name="group_num" value="${result.group_num}">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-8">
                                        <input type="text" class="tpl-form-input" id="group_buy_price" name="group_buy_price" value="${result.group_buy_price}">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-8">
                                        <input  type="text" id="starttime"  class="am-form-field tpl-form-no-bg" name="starttime" value="<fmt:formatDate value="${result.group_starttime}" pattern="yyyy-MM-dd HH:mm:ss" />"  readonly="">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-8">
                                        <input  type="text" id="endtime"  class="am-form-field tpl-form-no-bg" name="endtime" value="<fmt:formatDate value="${result.group_endtime}" pattern="yyyy-MM-dd HH:mm:ss" />"  readonly="">
